...
It is a good idea to check your expectation against the configuration specified using an image before calibration `multical boards my_board.yaml --detect my_image.jpeg`, 
...
`multical show /path/to/calibration/workspace.ws`
